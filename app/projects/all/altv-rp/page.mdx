...
## The American Dream
![The American Dream](/assets/projects/ad-1.png)
...
<figure className="my-6">
  <img src="/assets/projects/ad-2.png" alt="The chat" className="w-full h-auto rounded shadow" />
...
<video className="absolute top-0 left-0 w-full h-full" controls loop autoPlay playsInline muted>
  <source src="/assets/projects/ad-cc.mp4" type="video/mp4"/>
</video>
</div>
...
<div className="flex flex-wrap gap-4">
  <figure className="w-full md:w-[48%]">
    <img src="/assets/projects/ad-3.png" alt="Character Creation 1" className="w-full h-auto rounded shadow" />
  ...
  <figure className="w-full md:w-[48%]">
    <img src="/assets/projects/ad-4.png" alt="Character Creation 2" className="w-full h-auto rounded shadow" />
...
<div className="flex flex-wrap gap-4 mt-4">
  <figure className="w-full md:w-[48%] flex flex-col justify-between rounded shadow">
    <img src="/assets/projects/ad-7.png" alt="Character Creation 1" className="w-full h-auto rounded shadow" />
  ...
  <figure className="w-full md:w-[48%]">
    <img src="/assets/projects/ad-5.png" alt="Character Creation 2" className="w-full h-auto rounded shadow" />
...
<div className="flex justify-center mt-4">
  <figure className="w-full">
    <img src="/assets/projects/ad-6.png" alt="Character Creation 1" className="w-full h-auto rounded shadow" />
